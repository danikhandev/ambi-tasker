                                    ...
                                    <div key={field.key}>
                                        ...
                                        <div className="flex flex-wrap gap-x-4 gap-y-1 mt-1.5 px-1">
                                            <div className="flex items-center gap-1.5">
                                                {passwordForm.newPassword.length >= 8 ? <Check className="w-3 h-3 text-green-500" /> : <AlertCircle className="w-3 h-3 text-red-500/50" />}
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                {/[0-9]/.test(passwordForm.newPassword) ? <Check className="w-3 h-3 text-green-500" /> : <AlertCircle className="w-3 h-3 text-red-500/50" />}
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                {/[!@#$%^&*(),.?":{}|<>]/.test(passwordForm.newPassword) ? <Check className="w-3 h-3 text-green-500" /> : <AlertCircle className="w-3 h-3 text-red-500/50" />}
